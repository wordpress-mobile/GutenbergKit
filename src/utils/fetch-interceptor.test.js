...
describe( 'fetch-interceptor request body serialization', () => {
	let originalFetch;
	...
	it( 'should serialize FormData with files correctly', async () => {
		...
		expect( loggedRequest.requestBody ).toContain( 'file=<File: test.jpg' );
	...
	it( 'should serialize ArrayBuffer bodies correctly', async () => {
		...
		expect( loggedRequest.requestBody ).toBe( '[ArrayBuffer: 1024 bytes]' );
	} );
	...
	it( 'should serialize URLSearchParams bodies correctly', async () => {
		...
		expect( loggedRequest.requestBody ).toBe( 'key1=value1&key2=value2' );
	} );
	...
	it( 'should handle FormData with mixed content types', async () => {
		...
		expect( loggedRequest.requestBody ).toContain( 'file2=<File: doc.pdf' );
