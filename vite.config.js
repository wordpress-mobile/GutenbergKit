 ...
 * Uses local certificates generated by `make setup-https` if available.
 * This allows the dev server to work with HTTPS site URLs without mixed content blocking.
 */
